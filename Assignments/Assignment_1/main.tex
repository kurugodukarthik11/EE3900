...
\end{equation}
\begin{equation}
 c)   \abs{\brak{ \frac{-1}{2}}^(\brak{n-2})} \leq 1
\end{equation}
\begin{equation}
 d)   \abs{u(n-2)} \leq 1
\end{equation}
...
\item
What is type, order and  cutoff-frequency of the https://www.overleaf.com/project/62ef9e6ba73a18aa9841c914above butterworth filter
\\
\solution
