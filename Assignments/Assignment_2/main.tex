...
\author{ Karthik Kurugodu$^{*}$ %<-this  stops a space
...
\begin{lstlisting}
$ wget https://github.com/kurugodukarthik11/EE3900/blob/main/Assignments/Assignment_2/codes/q1.py
\end{lstlisting}
\end{enumerate}
...
\solution
\begin{lstlisting}
$ wget https://github.com/kurugodukarthik11/EE3900/blob/main/Assignments/Assignment_2/codes/q2.2.py
\end{lstlisting}
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{figs/2_2.pdf}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
\item Find $X^{+}(z)$.
...
\solution
\begin{lstlisting}
$ https://github.com/kurugodukarthik11/EE3900/blob/main/Assignments/Assignment_2/codes/q2.4.py
\end{lstlisting}
\begin{figure}[!htp]
    \includegraphics[width=\columnwidth]{figs/2_4.pdf}
    \caption{Plot of $x(n)$}
    \label{fig:xn}
\end{figure}
\item Find $Y^{+}(z)$. \\
