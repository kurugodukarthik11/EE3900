...
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{figs/voltmeter.jpg}
    \caption{Output of 5V}
    \label{fig:volt}
\end{figure}
...
\end{figure}
\begin{figure}[!ht]
    \includegraphics[width=\columnwidth]{figs/regulator_ac.jpeg}
    \caption{Output AC ripple at regulator stage across OG (5 mV).}
    \label{fig:regulator_ac}
\end{figure}
\begin{enumerate}
	\item Voltage of $5$V at output
